...
public class DocumentProcessingService {
    ...
    public DocumentProcessingService(PlatformRepository repo, MinioClient minio, DocParseService parser,
                                     ChunkService chunker, DashScopeService dash, QdrantService qdrant,
