...
public class DocParseService {
    ...
    public record ParsedPage(int pageNo, String content) { }
    ...
    /**
     * Extracts each physical PDF page independently so indexed chunks retain a reliable source page.
     * Scanned pages without extractable text are intentionally omitted from citations instead of guessed.
     */
    public List<ParsedPage> parsePdfPages(InputStream input) throws IOException {
        List<ParsedPage> pages = new java.util.ArrayList<>();
